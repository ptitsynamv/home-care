        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <div className="relative">
              <Link className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" href="/">Home</Link>
            </div>
            <Link className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" href="/about">About</Link>
            <Link className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" href="/blog">Blog</Link>
          </div>
